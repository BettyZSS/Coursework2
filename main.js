    ...
    play: function() {
        ...
        this.create = function() {
            ...
            appleTimer.loop(1000, function() {
                ...
                apple.width = game.world.width / 16;
...
// 贴加过渡效果
var showTween = game.addtween(goal).to({
    alpha:1,
    y：goal.y-20
},100,Phaser.Easing.Linear.None,ture,0,0,false);
showTween.onComplete.add(function){
    var hideTween = game.add.tween(goal).to({
        alpha:0,
        y:goal.y-20
    },1001.Phaser.Easing.Linear.None,ture,200,0,false);
    hideTweenonComplete.add(function(){
        goal.kill();
...
sorceMusic.play();
    ...
    over: function() {
        ...
        this.create = function() {
            ...
            var remind = game.add.text(game.world.centerX, game.world.height * 0.6, 'Click to play again', {
                fontSize: '20px',
                fontWeight: 'bold',
                fill: '#f2bb15'
            });
